...
|                   |                                   |
|-------------------|-----------------------------------|
| Make              | gymnasium.make("ALE/Hangman-v5")  |
...
|-----------------------|-------------|--------------|------------------------------|
| HangmanNoFrameskip-v4 | `"rgb"`     | `1`          | `0.00`                       |
| ALE/Hangman-v5        | `"rgb"`     | `4`          | `0.25`                       |

See the [version history page](https://ale.farama.org/environments/#version-history-and-naming-schemes) to implement previously implemented environments, e.g., `HangmanNoFrameskip-v4`.
