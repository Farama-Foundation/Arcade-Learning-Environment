...
reward_t RomSettings::getReward(int player) const {
  switch (player) {
    case 0: return getReward();
    case 1: return getRewardP2();
    case 2: return getRewardP3();
    case 3: return getRewardP4();
    default:
      throw std::out_of_range("player index must be in [0, 3]");
  }
}

int RomSettings::lives(int player) {
  switch (player) {
    case 0: return lives();
    case 1: return livesP2();
    case 2: return livesP3();
    case 3: return livesP4();
    default:
      throw std::out_of_range("player index must be in [0, 3]");
  }
}

ModeVect RomSettings::getModes(int num_players) {
  switch (num_players) {
    case 1: return getAvailableModes();
    case 2: return get2PlayerModes();
    case 3: return get3PlayerModes();
    case 4: return get4PlayerModes();
    default:
      throw std::out_of_range("number of players must be in [1, 4]");
  }
}
