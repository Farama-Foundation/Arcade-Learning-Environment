...
PYBIND11_MODULE(_ale_py, m) {
  ...
  py::enum_<ale::Action>(m, "Action")
      .value("PLAYER_A_NOOP", ale::PLAYER_A_NOOP)
      .value("PLAYER_A_FIRE", ale::PLAYER_A_FIRE)
      .value("PLAYER_A_UP", ale::PLAYER_A_UP)
      .value("PLAYER_A_RIGHT", ale::PLAYER_A_RIGHT)
      .value("PLAYER_A_LEFT", ale::PLAYER_A_LEFT)
      .value("PLAYER_A_DOWN", ale::PLAYER_A_DOWN)
      .value("PLAYER_A_UPRIGHT", ale::PLAYER_A_UPRIGHT)
      .value("PLAYER_A_UPLEFT", ale::PLAYER_A_UPLEFT)
      .value("PLAYER_A_DOWNRIGHT", ale::PLAYER_A_DOWNRIGHT)
      .value("PLAYER_A_DOWNLEFT", ale::PLAYER_A_DOWNLEFT)
      .value("PLAYER_A_UPFIRE", ale::PLAYER_A_UPFIRE)
      .value("PLAYER_A_RIGHTFIRE", ale::PLAYER_A_RIGHTFIRE)
      .value("PLAYER_A_LEFTFIRE", ale::PLAYER_A_LEFTFIRE)
      .value("PLAYER_A_DOWNFIRE", ale::PLAYER_A_DOWNFIRE)
      .value("PLAYER_A_UPRIGHTFIRE", ale::PLAYER_A_UPRIGHTFIRE)
      .value("PLAYER_A_UPLEFTFIRE", ale::PLAYER_A_UPLEFTFIRE)
      .value("PLAYER_A_DOWNRIGHTFIRE", ale::PLAYER_A_DOWNRIGHTFIRE)
      .value("PLAYER_A_DOWNLEFTFIRE", ale::PLAYER_A_DOWNLEFTFIRE)
      .value("PLAYER_B_NOOP", ale::PLAYER_B_NOOP)
      .value("PLAYER_B_FIRE", ale::PLAYER_B_FIRE)
      .value("PLAYER_B_UP", ale::PLAYER_B_UP)
      .value("PLAYER_B_RIGHT", ale::PLAYER_B_RIGHT)
      .value("PLAYER_B_LEFT", ale::PLAYER_B_LEFT)
      .value("PLAYER_B_DOWN", ale::PLAYER_B_DOWN)
      .value("PLAYER_B_UPRIGHT", ale::PLAYER_B_UPRIGHT)
      .value("PLAYER_B_UPLEFT", ale::PLAYER_B_UPLEFT)
      .value("PLAYER_B_DOWNRIGHT", ale::PLAYER_B_DOWNRIGHT)
      .value("PLAYER_B_DOWNLEFT", ale::PLAYER_B_DOWNLEFT)
      .value("PLAYER_B_UPFIRE", ale::PLAYER_B_UPFIRE)
      .value("PLAYER_B_RIGHTFIRE", ale::PLAYER_B_RIGHTFIRE)
      .value("PLAYER_B_LEFTFIRE", ale::PLAYER_B_LEFTFIRE)
      .value("PLAYER_B_DOWNFIRE", ale::PLAYER_B_DOWNFIRE)
      .value("PLAYER_B_UPRIGHTFIRE", ale::PLAYER_B_UPRIGHTFIRE)
      .value("PLAYER_B_UPLEFTFIRE", ale::PLAYER_B_UPLEFTFIRE)
      .value("PLAYER_B_DOWNRIGHTFIRE", ale::PLAYER_B_DOWNRIGHTFIRE)
      .value("PLAYER_B_DOWNLEFTFIRE", ale::PLAYER_B_DOWNLEFTFIRE)
      .export_values();
