...
class ALEState:
    ...
    @overload
    def __init__(self, state: ALEState, serialized: bytes) -> None: ...
    @overload
...
class ALEInterface:
    ...
    def act(
        self,
        actions: List[Action] | List[int],
        paddle_strengths: Optional[List[float]] = None,
    ) -> List[int]: ...
    def allLives(self) -> List[int]: ...
    ...
    @overload
    def getAvailableModes(self, num_players: int) -> List[int]: ...
